VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frm_DevolProducto 
   Caption         =   "PRODUCTO A FACTURAR"
   ClientHeight    =   5955
   ClientLeft      =   14930
   ClientTop       =   1970
   ClientWidth     =   15670
   OleObjectBlob   =   "frm_DevolProducto.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "frm_DevolProducto"
...
Private Sub btnAgregar_Click()
  If ComboBox1 = "" Then
   Call InsertarDevolProductodeListBox
    Exit Sub
