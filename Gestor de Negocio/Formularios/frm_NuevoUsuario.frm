...
Final = GetNuevoR(Hoja19)
        ...
        For Registro = 2 To Final
            If Hoja19.Cells(Registro, 1) = Me.txt_nUser.Text Then
      ...
      If Me.txt_pass1.Text = Me.txt_pass2.Text Then
                ...
                Hoja19.Cells(Final, 1) = Me.txt_nUser.Text
                Hoja19.Cells(Final, 2) = Me.txt_pass1.Text
                        If Me.OptionButton1.Value = True Then
                            Hoja19.Cells(Final, 3) = "Usuario"
                                Else
                            Hoja19.Cells(Final, 3) = "Administrador"
                        End If
                        
            ' Valor FALSO o VERDADERO para las hojas de cálculo
                Hoja19.Cells(Final, 4) = Me.CheckBox1.Value
                Hoja19.Cells(Final, 5) = Me.CheckBox2.Value
                Hoja19.Cells(Final, 6) = Me.CheckBox3.Value
                Hoja19.Cells(Final, 7) = Me.CheckBox4.Value
                Hoja19.Cells(Final, 8) = Me.CheckBox5.Value
                Hoja19.Cells(Final, 9) = Me.CheckBox6.Value
                Hoja19.Cells(Final, 10) = Me.CheckBox7.Value
                Hoja19.Cells(Final, 11) = Me.CheckBox8.Value
                Hoja19.Cells(Final, 12) = Me.CheckBox9.Value
                Hoja19.Cells(Final, 13) = Me.CheckBox10.Value
                Hoja19.Cells(Final, 14) = Me.CheckBox11.Value
                Hoja19.Cells(Final, 15) = Me.CheckBox12.Value
                Hoja19.Cells(Final, 16) = Me.CheckBox13.Value
                Hoja19.Cells(Final, 17) = Me.CheckBox14.Value
                Hoja19.Cells(Final, 18) = Me.CheckBox15.Value
                Hoja19.Cells(Final, 19) = Me.CheckBox16.Value
                Hoja19.Cells(Final, 20) = Me.CheckBox17.Value
                Hoja19.Cells(Final, 21) = Me.CheckBox18.Value
                Hoja19.Cells(Final, 22) = Me.CheckBox19.Value
                Hoja19.Cells(Final, 23) = Me.CheckBox20.Value
                Hoja19.Cells(Final, 24) = Me.CheckBox21.Value
                Hoja19.Cells(Final, 25) = Me.CheckBox22.Value
                Hoja19.Cells(Final, 26) = Me.CheckBox23.Value
                Hoja19.Cells(Final, 27) = Me.CheckBox24.Value
                Hoja19.Cells(Final, 28) = Me.CheckBox25.Value
                Hoja19.Cells(Final, 29) = Me.CheckBox26.Value
