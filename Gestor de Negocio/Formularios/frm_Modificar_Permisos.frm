...
Final = GetUltimoR(Hoja19)
    ...
    For Fila = 2 To Final
        If ComboBox1.Text = Hoja19.Cells(Fila, 1) Then
            Me.txt_Status = Hoja19.Cells(Fila, 3)
...
End If
    ...
    For Fila = 2 To Final
        If Me.ComboBox1.Text = Hoja19.Cells(Fila, 1) Then
...
MsgBox "Cambios guardados satisfactoriamente", vbInformation, "Gestor de Inventarios"
    ...
    Unload Me
    Hoja20.txt_UsuarioActual.Text = Empty
    frm_Login.Show
