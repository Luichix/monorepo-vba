VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frm_ListadoAbono 
   Caption         =   "GESTOR DE VENTA DE ACTIVOS"
   ClientHeight    =   9795.001
   ClientLeft      =   120
   ClientTop       =   470
   ClientWidth     =   18530
   OleObjectBlob   =   "frm_ListadoAbono.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "frm_ListadoAbono"
...
Private Sub btn_Cargar_Click()
   ...
   If frm_ListadoAbono.lbx_ListadoAbono.Column(8) = 0 Then
    MsgBox "Este abono ya ha sido finalizado...!", vbInformation, "GESTOR DE RECURSOS HUMANOS"
    Else
    
    With frm_ListadoAbono
        .Visualizar_ListadoAbono
    End With
...
Private Sub btn_CargarTodo_Click()
    With frm_Cuota_Abono
        .ListBox1.Clear
        .sumarImporte
        .Cargar_Todo
...
Me.btn_CargarTodo.Visible = True
End Sub
...
Me.btn_CargarTodo.Visible = False
End Sub
Public Sub Visualizar_ListadoAbono()
Dim Fila As Long
Dim Final As Long
...
frm_ListadoAbono.ListBox1.ColumnCount = 5
frm_ListadoAbono.ListBox1.ColumnWidths = "70 pt;170 pt;70 pt;100 pt;50 pt"
frm_ListadoAbono.ListBox1.RowSource = "Tbl_deposito"

uf = Hoja12.Range("A" & Rows.Count).End(xlUp).Row

Hoja12.AutoFilterMode = False
frm_ListadoAbono.ListBox1 = Clear
frm_ListadoAbono.ListBox1.RowSource = Clear

For Fila = 2 To uf
    STRG = Hoja12.Cells(Fila, 9).Value 'Variable para descripción

    If UCase(STRG) Like Referencia Then
        frm_ListadoAbono.ListBox1.AddItem
        frm_ListadoAbono.ListBox1.List(X, 0) = Hoja12.Cells(Fila, 5).Text
        frm_ListadoAbono.ListBox1.List(X, 1) = Hoja12.Cells(Fila, 6).Text
        frm_ListadoAbono.ListBox1.List(X, 2) = Hoja12.Cells(Fila, 7).Value
        frm_ListadoAbono.ListBox1.List(X, 2) = Replace(frm_ListadoAbono.ListBox1.List(X, 2), ",", ".")
        frm_ListadoAbono.ListBox1.List(X, 3) = Hoja12.Cells(Fila, 8).Text
        frm_ListadoAbono.ListBox1.List(X, 4) = Hoja12.Cells(Fila, 10).Text
        frm_ListadoAbono.ListBox1.List(X, 5) = Hoja12.Cells(Fila, 9).Text
...
frm_ListadoAbono.ListBox1.ColumnCount = 5
frm_ListadoAbono.ListBox1.ColumnWidths = "70 pt;170 pt;70 pt;110 pt;50 pt"
...
For Fila = 2 To uf
    ...
    If UCase(STRG) Like Estado Then
        ...
        Me.lbx_ListadoAbono.List(X, 0) = Hoja8.Cells(Fila, 3).Value
